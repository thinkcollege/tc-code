                                ...
                                if ($pid=='')
                                {
    			                    ...
    			                    if ($database->query())
                                    {
                                        ...
                                        { //they're allowed
                                           ...
                                           // Hack **  --to subscribe everyone to TPSID forum
                                           if ($catid <= '2') { $database->setQuery("SELECT * FROM #__users WHERE (usertype='Author' OR id=167 OR id=65 OR id=195) AND id NOT IN (102,106,97,137,126,68,171,317,321,329,196)");} 
elseif ($catid == '8') { $database->setQuery("SELECT * FROM #__users WHERE usertype='Registered'");}
else 
