...
(function(jQuery) {
    jQuery.fn.formToWizard = function(options) {
        ...
        steps.each(function(i) {
            ...
            jQuery("#steps").append("<li id='stepDesc" + i + "'><a href='/tc-live/module-1/how-to-become-a-ctp#' id=\"iconSel"+ (i) + "\"><span id='icon' class='officon'></span></a>Step " + (i + 1) + "<span>" + name + "</span></li>");
 	 var stepName = "step" + i;
 jQuery("#iconSel" + (i)).bind("click", function(e) {
        ...
        function createPrevButton(i) {
            var stepName = "step" + i;
            jQuery("#" + stepName + "commands").append("<a href='/tc-live/module-1/how-to-become-a-ctp#' id='" + stepName + "Prev' class='prev'>< Back</a>");
        ...
        function createNextButton(i) {
            var stepName = "step" + i;
            jQuery("#" + stepName + "commands").append("<a href='/tc-live/module-1/how-to-become-a-ctp#' id='" + stepName + "Next' class='next'>Next step ></a>");
        ...
        function createNext2Button(i) {
            var stepName = "step" + i;
            jQuery("#" + stepName + "commands2").append("<a href='/tc-live/module-1/how-to-become-a-ctp#' id='" + stepName + "Next2' class='next'>Next step ></a>");
        ...
        function selectStep(i) {
            ...
            jQuery("#steps li #icon").removeClass("currenticon");
            jQuery("#steps li #icon").addClass("officon");
           jQuery("#stepDesc" + i + " #icon").removeClass("officon");
            jQuery("#stepDesc" + i + " #icon").addClass("currenticon");
