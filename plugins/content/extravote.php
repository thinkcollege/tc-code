...
-->
		...
		if ( (int)$xid ) { 
	 	...
	 	$html="<p style=\"margin-bottom: 3px; padding-bottom: 2px\"><strong>Vote!</strong><br />Click on a star to rate the usefulness of this resource.</p> 
<div class=\"extravote-container".$stars."\"".( $xid != 'x' ? "" : " style=\"margin-top:1px;margin-bottom: 8px;\"" ).">
