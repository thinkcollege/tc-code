...
*/
		...
		_addControls : function(v, tb) {
			...
			each(explode(v), function(n) {
				...
				if (n == 'tablecontrols') {
					each(["table","|","delete_table","table_props","row_props","cell_props","|","row_before","row_after","delete_row","|","col_before","col_after","delete_col","|","split_cells","merge_cells"], function(n) {
