...
<p class="loginBlurb">Do you have ICE colleagues who would benefit from access to this forum? To give them access send an e-mail stating their name and e-mail address to <a href="mailto:maria.paiewonsky@umb.edu">maria.paiewonsky@umb.edu</a></p></form>
<?php else : ?>
<form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="login" class="form-login">
	...
	<input type="checkbox" name="remember" id="mod_login_remember" class="checkbox" checked value="yes" alt="<?php echo JText::_('Remember me'); ?>" />
