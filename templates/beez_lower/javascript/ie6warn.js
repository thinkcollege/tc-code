...
var RokIEWarn = new Class({
	'site': 'sitename',
	'initialize': function() {
		var warning = "<h3>Your are currently browsing this site with Internet Explorer 6 (IE6).</h3><h4>NOTE: The Think College website is compatible with IE6, however due to limitiations in the browser, some of the graphics and visual effects have been reduced.</h4><p>The last version of Internet Explorer 6 was called Service Pack 1 for Internet Explorer 6 and was released in December of 2004.  By continuing to run Internet Explorer 6 you are open to any and all security vulnerabilities discovered since that time.</p> <br /><a class=\"external\"  href=\"http://www.microsoft.com/windows/internet-explorer/worldwide-sites.aspx\">Download Internet Explorer 8 NOW!</a>";
