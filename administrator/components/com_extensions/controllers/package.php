<?php
/**
 * @version		$Id: package.php 769 2010-12-20 23:55:44Z stian $
 * @category	Nooku
 ...
 * @subpackage  Extensions
 */
class ComExtensionsControllerPackage extends ComDefaultControllerDefault
{
	/**
	 * Constructor
	 *
	...
	public function displayView(KCommandContext $context)
	{
		...
		elseif(KRequest::has('get.file', 'filename'))
		{
			...
			ob_start();
			echo KFactory::get('admin::com.extensions.view.packages.html')
		...
		$context->result = json_encode($data);
	}
}