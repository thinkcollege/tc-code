<?php
/**
 * @version		$Id: dashboard.php 555 2010-10-29 19:37:52Z stian $
 * @category	Nooku
 ...
 * @subpackage  Extensions
 */
class ComExtensionsControllerDashboard extends ComDefaultControllerDefault
{
	...
	protected function _actionUpdate()
	{
		...
		// Prepare curl
		$curl = KFactory::get('admin::com.extensions.helper.curl');
		...
		// @TODO This is just a temporary workaround until com_extensions is out of the incubator, and in the trunk
		JFolder::copy(JPATH_COMPONENT_ADMINISTRATOR, JPATH_ROOT.'/tmp/code/administrator/components/com_extensions');
		JFolder::copy(JPATH_ROOT.'/tmp/code/administrator/components/com_extensions/install', JPATH_ROOT.'/tmp/code/install');
		JFile::move(JPATH_ROOT.'/tmp/code/administrator/components/com_extensions/manifest.xml', JPATH_ROOT.'/tmp/code/manifest.xml');
