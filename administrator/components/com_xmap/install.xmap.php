<?php
/**
 * $Id: install.xmap.php 167 2011-10-18 00:41:58Z guilleva $
 * $LastChangedDate: 2011-10-17 18:41:58 -0600 (Mon, 17 Oct 2011) $
...
if ( file_exists( $pathLangFile . $tmp_lng . '.php' )){
    ...
    <table border="0" width="90%">
	    <tr>
		    ...
		    <td width="80%"><b>Xmap 1.2.14 Stable</b></td>
	    </tr>
	    <tr>
		...
		<tr>
			...
			<br />
			<font color="green"><b>Xmap 1.2.14 has been installed successfully! Thank you for using Xmap! Settings can be configured in the <a href="index.php?option=com_xmap">&rarr; component menu</a>!</b></font><br /><br />
			<br /></td>
		</tr>
	    <tr>
	      <td>&nbsp;</td>
